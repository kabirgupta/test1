 ...
 * @author kabir
 */
public class SummationOfTwoNumbers extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public SummationOfTwoNumbers() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SummationOfTwoNumbers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SummationOfTwoNumbers().setVisible(true);
            }
        });
    }
